...
<div class="col-md-12">
    <div class="box box-primary">
        <div class="box-header with-border">
            <h3 class="titleJudul biru">REQUEST TANDA TANGAN</h3>

            <div class="col-md-12 mt10">
                <form action="requestttd" method="get">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control pull-right" name="nomorsurat" autocomplete="off"
                        value="{{ isset($_GET['nomorsurat']) ? $_GET['nomorsurat'] : '' }}">
                        </div>
                    </div>
                    <div class="col-md-3 ml-15">
                        <label>Perihal</label>
                        <input type="text" class="form-control pull-right" name="perihal" value="{{ isset($_GET['perihal']) ? $_GET['perihal'] : '' }}" autocomplete="off">
                    </div>
        ...
        <div class="box-body no-padding">
            ...
            <div class="box-body">
                ...
                <div class="alert alert-info alert-dismissible">
                  ...
                  Tidak ada permintaan tanda tangan dari manapun ...
                </div>
              </div>
            ...
            <a href="/previewSurat/{{$datas->norec }}/{{ Auth::user()->key }}?back=requestttd" >
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <div class="info-box bg-{{ $datas->class }}">
                        ...
                        <span class="info-box-number"> {{ mb_strimwidth($datas->perihal, 0, 30, "...") }} </span>
                            <div class="progress"> 
        ...
        <div class="box-footer no-padding">
            <div class="mailbox-controls">
                ...
                <div class="pull-right">
                  {{ $ttd->appends(request()->query())->links() }}
